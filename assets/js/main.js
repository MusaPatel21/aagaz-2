...
document.querySelectorAll('.primary-btn.small-primary').forEach(button => {
...
document.getElementById('bookingForm').addEventListener('submit', function (e) {
  ...
  let whatsappMessage = `Booking Request:\nName: ${name}\nPhone: ${phone}\nEmail: ${email}\nDate: ${date}\nMessage: ${message}`;

  // Encode message for URL
  whatsappMessage = encodeURIComponent(whatsappMessage);

  // Open WhatsApp
  const whatsappURL = `https://wa.me/9822407884?text=${whatsappMessage}`;
